        ...
        <div class="flex flex-col items-center gap-6 pt-10 border-t border-gray-100 dark:border-gray-800">
            ...
            <div class="flex flex-wrap justify-center items-center gap-x-12 gap-y-6 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-[11px] font-bold text-gray-500 uppercase tracking-tight">Transferencia</span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="material-symbols-outlined text-[26px]">payments</span>
                    <span class="text-[11px] font-bold text-gray-500 uppercase tracking-tight">Efectivo</span>
                </div>
            </div>
        </div>
    </div>
...
files.forEach(f => {
    ...
    if (c.includes('<!-- Payment Methods -->')) {
        ...
        console.log(`Massive SVG fix for ${f}`);
    }
});
